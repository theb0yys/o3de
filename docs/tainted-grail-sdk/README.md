...
- pinned Tainted Framework `0.1.33` knowledge, complete selected-component classification, canonical golden fixtures, exact Mono/IL2CPP evidence separation, and the first named governed ExtensionAPI consumer without runtime-host linkage;
