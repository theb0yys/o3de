...
#undef TG_INTERCHANGE_ID_WRAPPER
    ...
    struct CanonicalSpatialBasisV1 { AZStd::string m_handedness = "right_handed"; AZStd::string m_rightAxis = "+x"; AZStd::string m_forwardAxis = "+y"; AZStd::string m_upAxis = "+z"; AZStd::string m_linearUnit = "metre"; AZStd::string m_angularUnit = "radian"; AZStd::string m_vectorConvention = "column_vector"; AZStd::string m_multiplicationConvention = "matrix_on_left"; AZStd::string m_storageOrder = "column_major"; };
